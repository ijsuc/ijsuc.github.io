...
import JasonDriving from "./service/JasonDriving.vue";
import JasonGeocoder from "./service/JasonGeocoder.vue";
import JasonMarker from "./service////JasonMarker.vue";
...
export default {
  install (Vue, options) {
    ...
    Vue.component('jason-driving', JasonDriving)
    Vue.component('jason-geocoder', JasonGeocoder)
    Vue.component('jason-marker', JasonMarker)
...
export {
  ...
  BmLocalSearch, BmTransit, BmWalking, BmDriving, JasonDriving, JasonGeocoder, JasonMarker, BmBus,
  BmTile, BmTraffic,
  BmBoundary
}
